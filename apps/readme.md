...
```
wget https://github.com/dinoboards/ez80-clang/releases/download/v0.0.13-rc.49/ez80-clang-v0.0.13-rc.49.tar.gz
tar -xzvf ez80-clang-v0.0.13-rc.49.tar.gz
cd ez80-clang-v0.0.13-rc.49
sudo ./install.sh
```
