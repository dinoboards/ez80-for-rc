...
```
wget https://github.com/dinoboards/ez80-clang/releases/download/v0.0.13-rc.83/ez80-clang-v0.0.13-rc.83.tar.gz
tar -xzvf ez80-clang-v0.0.13-rc.83.tar.gz
cd ez80-clang-v0.0.13-rc.83
sudo ./install.sh
```
