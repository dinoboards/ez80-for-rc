...
```
wget https://github.com/dinoboards/ez80-clang/releases/download/v0.0.14/ez80-clang-v0.0.14.tar.gz
tar -xzvf ez80-clang-v0.0.14.tar.gz
cd ez80-clang-v0.0.14
sudo ./install.sh
```
