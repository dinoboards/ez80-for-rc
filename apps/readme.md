...
```
wget https://github.com/dinoboards/ez80-clang/releases/download/v0.0.13-rc.61/ez80-clang-v0.0.13-rc.61.tar.gz
tar -xzvf ez80-clang-v0.0.13-rc.61.tar.gz
cd ez80-clang-v0.0.13-rc.61
sudo ./install.sh
```
