...
```
wget https://github.com/dinoboards/ez80-clang/releases/download/v0.0.15/ez80-clang-v0.0.15.tar.gz
tar -xzvf ez80-clang-v0.0.15.tar.gz
cd ez80-clang-v0.0.15
sudo ./install.sh
```
