...
```
wget https://github.com/dinoboards/ez80-clang/releases/download/v0.0.13-rc.45/ez80-clang-v0.0.13-rc.45.tar.gz
tar -xzvf ez80-clang-v0.0.13-rc.45.tar.gz
cd ez80-clang-v0.0.13-rc.45
sudo ./install.sh
```
