...
#define USAGE "usage: whet [-C] [loops]\n"
...
int main(int argc, char *argv[])
{
   ...
   printf("Conducting Whetstone benchmark.  Please wait.\n");
...
IILOOP:
   ...
   */
   ...
   printf("Loops: %ld, Iterations: %d, Duration: %6.1f sec.\n",
          LOOP, II, usertime);

   KIPS = (100.0 * LOOP * II) / (double_t)(usertime);
   if (KIPS >= 1000.0)
