...
void A_Slurpie(objtype *_ __attribute__((unused))) { SD_PlaySound(SLURPIESND); }

void A_Breathing(objtype *_ __attribute__((unused))) { SD_PlaySound(ANGELTIREDSND); }
...
void A_Victory(objtype *_ __attribute__((unused))) { playstate = ex_victorious; }
...
void T_BJDone(objtype *_ __attribute__((unused))) {
