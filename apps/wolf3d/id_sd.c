...
static inline void YM3812Write(DBOPL::Chip &which, Bit32u reg, Bit8u val) { which.WriteReg(reg, val); }
...
void __interrupt SDL_t0FastAsmService(void) { SDL_DoFast(); }
...
void SDL_IndicatePC(boolean ind) { pcindicate = ind; }
...
void SD_PrepareSound(int which) {
  ...
  int16_t *newsamples = (int16_t *)(void *)(wavebuffer + sizeof(headchunk) + sizeof(wavechunk));
  float    cursample  = 0.F;
