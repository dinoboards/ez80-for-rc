...
#
# ZDS II Make File - rc2014-firmware project, alt-release configuration
#
...
LDFLAGS = @.\rc2014-firmware_alt-release.linkcmd
...
deltarget: 
	@if exist "Z:\rc2014-ez80\firmware\bin\rc2014-alt-release-firmware.lod"  \
            $(RM) "Z:\rc2014-ez80\firmware\bin\rc2014-alt-release-firmware.lod"
	@if exist "Z:\rc2014-ez80\firmware\bin\rc2014-alt-release-firmware.hex"  \
