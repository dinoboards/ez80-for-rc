...
#
# ZDS II Make File - rc2014-alt-firmware project, debug configuration
#
...
WORKDIR = Z:\rc2014-ez80\firmware\alt-debug
WORKDIR_ESCSPACE = Z:\rc2014-ez80\firmware\alt-debug

# output files directory
OUTDIR = Z:\rc2014-ez80\firmware\alt-debug\
OUTDIR_ESCSPACE = Z:\rc2014-ez80\firmware\alt-debug\
...
-define:RC2014_FIRMWARE -define:RC2014_ALT_FIRMWARE -genprintf  \
...
-asmsw:"   \
	-define:_EZ80ACCLAIM!=1 -define:RC2014_ALT_FIRMWARE=1  \
	-define:RC2014_FIRMWARE=1 -define:FIRMWARE_BASE=%010000  \
...
LDFLAGS = @.\rc2014-alt-firmware_debug.linkcmd
build: rc2014-alt-firmware

buildall: clean rc2014-alt-firmware

relink: deltarget rc2014-alt-firmware

deltarget: 
	@if exist "$(WORKDIR)\rc2014-alt-firmware.lod"  \
            $(RM) "$(WORKDIR)\rc2014-alt-firmware.lod"
	@if exist "$(WORKDIR)\rc2014-alt-firmware.hex"  \
            $(RM) "$(WORKDIR)\rc2014-alt-firmware.hex"
	@if exist "$(WORKDIR)\rc2014-alt-firmware.map"  \
            $(RM) "$(WORKDIR)\rc2014-alt-firmware.map"
