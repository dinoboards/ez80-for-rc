...
static point_t intersect(line_t l, uint8_t edge) {
  if (edge & 8)
    return point_new(l.a.x + (l.b.x - l.a.x) * (gviewport.top - l.a.y) / (l.b.y - l.a.y), gviewport.top);

  if (edge & 4)
    return point_new(l.a.x + (l.b.x - l.a.x) * (gviewport.bottom - l.a.y) / (l.b.y - l.a.y), gviewport.bottom);

  if (edge & 2)
    return point_new(gviewport.right, l.a.y + (l.b.y - l.a.y) * (gviewport.right - l.a.x) / (l.b.x - l.a.x));
