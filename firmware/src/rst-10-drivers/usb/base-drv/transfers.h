...
#define RT_HOST_TO_DEVICE 0x00 /* 0000 0000 */
#define RT_DEVICE_TO_HOST 0x80 /* 1000 0000 */
#define RT_STANDARD       0x00 /* 0000 0000 */
#define RT_CLASS          0x20 /* 0010 0000 */
#define RT_VENDOR         0x40 /* 0100 0000 */
#define RT_DEVICE         0x00 /* 0000 0000 */
#define RT_INTERFACE      0x01 /* 0000 0001 */
#define RT_ENDPOINT       0x02 /* 0000 0010 */
#define RT_OTHER          0x03 /* 0000 0011 */
