 ...
 *
 */
const char scancodes_shift_table[128] = {
    0x00, /*Reserved*/
    0x00, /*Reserved*/
    0x00, /*Reserved*/
    0x00, /*Reserved*/
...
const char scancodes_table[128] = {
    0x00, /*Reserved*/
    0x00, /*Reserved*/
    0x00, /*Reserved*/
    0x00, /*Reserved*/
...
char char_with_caps_lock(const char c, const bool caps_lock_engaged) {
...
char scancode_to_char(const uint8_t modifier_keys, const uint8_t code, const bool caps_lock_engaged) {
