...
#define VDP_IO_DATA ((uint24_t)0xFF98)
#define VDP_IO_ADDR ((uint24_t)0xFF99)
#define VDP_IO_PALT ((uint24_t)0xFF9A)
#define VDP_IO_REGS ((uint24_t)0xFF9B)

#define VDP_DATA (*(XSFR)VDP_IO_DATA)
#define VDP_ADDR (*(XSFR)VDP_IO_ADDR)
#define VDP_PALT (*(XSFR)VDP_IO_PALT)
#define VDP_REGS (*(XSFR)VDP_IO_REGS)
#else
...
#define VDP_PALT (*((uint8_t *)VDP_IO_PALT))
#define VDP_REGS (*((uint8_t *)VDP_IO_REGS))
 ...
 */
#define vdp_get_refresh() (registers_mirror[9] & 0x02 ? 50 : 60;)
