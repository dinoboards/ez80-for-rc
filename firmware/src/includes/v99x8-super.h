...
#define WS2812_LEDIDX_ADDR 0xFFFF30
#define WS2812_LEDVAL_ADDR 0xFFFF31
#define WS2812_LEDCNT_ADDR 0xFFFF32

#define WS2812_LEDIDX (*((uint8_t *)WS2812_LEDIDX_ADDR))
#define WS2812_LEDVAL (*((uint8_t *)WS2812_LEDVAL_ADDR))
#define WS2812_LEDCNT (*((uint8_t *)WS2812_LEDCNT_ADDR))
 ...
 */
#define ws2812_set_pixel(index, rgb)                                                                                               \
  {                                                                                                                                \
    WS2812_LEDIDX = index;                                                                                                         \
                                                                                                                                   \
